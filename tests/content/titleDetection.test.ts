...
describe('detectAndMarkTitle', () => {
  ...
  it('2.1.1 — logs trimmed text when h1.product-title is present', () => {
  ...
  it('2.1.2 — falls back to plain h1 and logs its trimmed text', () => {
  ...
  it('2.1.3 — takes warn path when h1.product-title has whitespace-only textContent', () => {
  ...
  it('2.2.1 — applies underline + blue to h1.product-title', () => {
  ...
  it('2.2.2 — sets only textDecoration and textDecorationColor (no other inline styles)', () => {
    document.body.innerHTML = '<h1 class="product-title">Wingspan</h1>';
    vi.spyOn(console, 'log').mockImplementation(() => {});
    detectAndMarkTitle();
    const el = document.querySelector('h1.product-title') as HTMLElement;
  ...
  it('2.2.3 — applies underline + blue to fallback h1', () => {
  ...
  it('2.3.1 — warns with BGG Rank Enricher message when no h1 at all', () => {
  ...
  it('2.3.1b — does not modify any DOM node when no h1 exists', () => {
  ...
  it('2.3.2 — warns when h1 has empty textContent', () => {
  ...
  it('2.3.2b — does not style the h1 when textContent is empty', () => {
    document.body.innerHTML = '<h1></h1>';
    vi.spyOn(console, 'warn').mockImplementation(() => {});
    detectAndMarkTitle();
    const el = document.querySelector('h1') as HTMLElement;
  ...
  it('2.3.3 — warns when h1 has whitespace-only textContent', () => {
  ...
  it('2.3.3b — does not style the h1 when textContent is whitespace-only', () => {
    document.body.innerHTML = '<h1>   </h1>';
    vi.spyOn(console, 'warn').mockImplementation(() => {});
    detectAndMarkTitle();
    const el = document.querySelector('h1') as HTMLElement;
  ...
  it('2.3.4 — never calls console.error and never throws', () => {
